= Listmunger - refreshes a folder of plain-text lists according to your evolving rules
...
source file to a target file.  Listmunger starts by backing up all of the
...
part of this Github project -- see Google Code for the stable version [3] --
but as of May 2012 I am learning Ruby and intend to write a version in Ruby,
Listmunger.
